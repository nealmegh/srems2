import pandas as pd
import numpy as np
from sklearn.tree import DecisionTreeRegressor  # Changed from RandomForestRegressor
...
class InterpolationByPciUsingDT:  # Renamed the class
    ...
    #             model = DecisionTreeRegressor(random_state=42)  # Use Decision Tree Regressor
    ...
    #             metrics_df.loc[len(metrics_df)] = [pci, num_data_points, training_duration, rmse_cv, mae, rmse, mbe, r2, std_dev]
    #         else:
    ...
    def train_pci_models(self):
        ...
        for pci, group in self.pci_groups:
            ...
            training_duration = end_train_time - start_train_time
            metrics_df.loc[len(metrics_df)] = [pci, num_data_points, training_duration, rmse_cv, mae, rmse, mbe, r2,
                                               std_dev]
